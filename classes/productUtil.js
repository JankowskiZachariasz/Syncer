        ...
        Object.keys(map).map(function (key) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                switch (product) {
                    ...
                    case (3): {
                        console.log('O pólnocy ze dwa razy i nad ranem jeszcze z raz:');
                        console.log(map[key][0].namePlc);
                        console.log(map[key][1].namePlc);
                        console.log(map[key][0].namePlc != map[key][1].namePlc);
                        if ( //if there is any differance -> write 1bstract to DB_EDIT
                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                ...
                                case 1:
                                    ...
                                    if (!(localDelete.length > 0)) return [3 /*break*/, 5];
                                    _a.label = 2;
                                case 2:
                                    _a.trys.push([2, 4, , 5]);
                                    return [4 /*yield*/, paczka_1["default"].deleteMany({ _id: { $in: localDelete } })];
